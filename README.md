...
│   ├── configs.py              # Configuration & Schema
│   ├── feature_store.py        # Data processing
│   └── policy_head.py          # RL Policy Network
├── kaggle/
│   ├── work/                   # Execution scripts
│   │   ├── starter_notebook.py # MAIN SUBMISSION FILE
│   │   ├── sft_nhits.py        # Base model training
│   │   ├── gen_sft_signals.py  # Signal generation
│   │   └── train_grpo.py       # RL Policy training
│   └── input/                  # Data directory (Kaggle structure)
└── models/                     # Saved artifacts (local)
```
